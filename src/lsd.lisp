            ...
            (sdl2:with-event-loop (:method :poll)
              (:keydown (:keysym keysym)
               (when (sdl2:scancode= (sdl2:scancode-value keysym) :scancode-up)
                 (handle-input (game-scene game) :u t))
               (when (sdl2:scancode= (sdl2:scancode-value keysym) :scancode-down)
                 (handle-input (game-scene game) :d t))
               (when (sdl2:scancode= (sdl2:scancode-value keysym) :scancode-left)
                 (handle-input (game-scene game) :l t))
               (when (sdl2:scancode= (sdl2:scancode-value keysym) :scancode-right)
                 (handle-input (game-scene game) :r t))
               (when (sdl2:scancode= (sdl2:scancode-value keysym) :scancode-lshift)
                 (handle-input (game-scene game) :s t))
               (when (sdl2:scancode= (sdl2:scancode-value keysym) :scancode-z)
                 (handle-input (game-scene game) :z t))
               (when (sdl2:scancode= (sdl2:scancode-value keysym) :scancode-escape)
                 (sdl2:push-event :quit)))
              (:keyup (:keysym keysym)
               (when (sdl2:scancode= (sdl2:scancode-value keysym) :scancode-up)
                 (handle-input (game-scene game) :u nil))
               (when (sdl2:scancode= (sdl2:scancode-value keysym) :scancode-down)
                 (handle-input (game-scene game) :d nil))
               (when (sdl2:scancode= (sdl2:scancode-value keysym) :scancode-left)
                 (handle-input (game-scene game) :l nil))
               (when (sdl2:scancode= (sdl2:scancode-value keysym) :scancode-right)
                 (handle-input (game-scene game) :r nil))
               (when (sdl2:scancode= (sdl2:scancode-value keysym) :scancode-lshift)
                 (handle-input (game-scene game) :s nil))
               (when (sdl2:scancode= (sdl2:scancode-value keysym) :scancode-z)
                 (handle-input (game-scene game) :z nil)))
              (:idle ()
